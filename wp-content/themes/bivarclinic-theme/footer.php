            ...
            <div class="section contact">
                <div class="container">
                    <h1 class="title-section primary">Contactos</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="button">
                                <a href="contactos" class="button-default">Marcar avaliação</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php 
                                $localizacao = get_field('localizacao','option');

                                if ($localizacao) :
                            ?>
                                <p class="mb-2"><?php echo $localizacao; ?></p>
                            <?php endif; ?>
                            <?php 
                                $numero_de_registo_ers = get_field('numero_de_registo_ers','option');

                                if ($numero_de_registo_ers) :
                            ?>
                                <p class="m-0">Número de Registo ERS: <b><?php echo $numero_de_registo_ers; ?></b></p>
                            <?php endif; ?>
                            <?php 
                                $numero_licenca_ers = get_field('numero_licenca_ers','option');

                                if ($numero_licenca_ers) :
                            ?>
                                <p class="mb-2">Número licença ERS: <b><?php echo $numero_licenca_ers; ?></b></p>
                            <?php endif; ?>

                            <p><a target="_blank" href="politica-de-privacidade">Politica de Privacidade</a></p>
                        </div>
                        <div class="col-sm-3">
                            <h6 class="text-uppercase">Contacto</h6>
                            <p class="mb-2"><a target="_blank" href="tel:+351963732515">(+351) 963 732 515 <br />(chamada para rede móvel nacional)</a></p>
                            <p><a target="_blank" href="mailto:info@bivarclinic.pt?subject=Dúvidas via website&body=Olá, gostaria de tirar algumas dúvidas">info@bivarclinic.pt</a></p>
                        </div>
                        <div class="col-sm-3">
                            <h6 class="text-uppercase">Horário</h6>
                            <?php 
                        ...
                        <div class="col-sm-3">
                            <h6 class="text-uppercase d-none d-md-block">Social</h6>
                                        ...
                                        <a href="<?php echo $facebook; ?>" target="_blank">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <g clip-path="url(#clip0_269_17)">
                                                    <path
                                                        d="M18 0H14.4545C12.8874 0 11.3844 0.632141 10.2762 1.75736C9.16802 2.88258 8.54545 4.4087 8.54545 6V9.6H5V14.4H8.54545V24H13.2727V14.4H16.8182L18 9.6H13.2727V6C13.2727 5.68174 13.3972 5.37652 13.6189 5.15147C13.8405 4.92643 14.1411 4.8 14.4545 4.8H18V0Z"
                            ...
                            <div class="book">
                                <a href="https://www.livroreclamacoes.pt/Inicio/" target="_blank">
                                    <span class="circle">Livro de</span> reclamações
                                </a>
                            </div>
                        </div>
                    </div>
